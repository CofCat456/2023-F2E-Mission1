...
const mobileNavRef: Ref<HTMLHeadElement> | undefined = inject('mobileNavRef')
</script>

<template>
  <!-- Nav -->
  <nav ref="mobileNavRef" class="px-2 fixed xl:hidden bottom-0 left-0 right-0 border-t border-colorTheme3 bg-white z-40">
